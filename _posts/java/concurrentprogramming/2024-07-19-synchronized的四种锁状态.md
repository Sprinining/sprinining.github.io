---
title: synchronized的四种锁状态
date: 2024-07-19 03:40:46 +0800
...
当对象状态为偏向锁时，`Mark Word`存储的是偏向的线程 ID；当状态为轻量级锁时，`Mark Word`存储的是指向线程栈中`Lock Record`的指针；当状态为重量级锁时，`Mark Word`为指向堆中的 monitor（监视器）对象的指针。
...
![synchronized-20230728110319](/assets/media/pictures/java/synchronized的四种锁状态.assets/synchronized-20230728110319.png)
...
![synchronized-20230728112620](/assets/media/pictures/java/synchronized的四种锁状态.assets/synchronized-20230728112620.png)
...
![synchronized-20230728114101](/assets/media/pictures/java/synchronized的四种锁状态.assets/synchronized-20230728114101.png)
