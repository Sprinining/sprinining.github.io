...
tags: [Algorithm, Sort]
description: 排序是将数据按特定顺序排列的过程，常见算法有冒泡排序、选择排序、插入排序、快速排序和归并排序。
---
## 排序
### 比较

![image-20220506135639856](/assets/media/pictures/algorithm/排序.assets/image-20220506135639856.png)

### 分类

![image-20220506135704565](/assets/media/pictures/algorithm/排序.assets/image-20220506135704565.png)
